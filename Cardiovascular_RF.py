...
RF_result = accuracy_score(y_test,y_predict)
...
print("Fold=10, cv_score=", cv_result.mean())
kfold = KFold(n_splits=9)  
cv_result = cross_val_score(model, x, y, cv=kfold)
print("Fold=9, cv_score=", cv_result.mean())
kfold = KFold(n_splits=8)  
cv_result = cross_val_score(model, x, y, cv=kfold)
print("Fold=8, cv_score=", cv_result.mean())
kfold = KFold(n_splits=7)  
cv_result = cross_val_score(model, x, y, cv=kfold)
print("Fold=7, cv_score=", cv_result.mean())
kfold = KFold(n_splits=6)  
cv_result = cross_val_score(model, x, y, cv=kfold)
print("Fold=6, cv_score=", cv_result.mean())
kfold = KFold(n_splits=5)  
cv_result = cross_val_score(model, x, y, cv=kfold)
print("Fold=5, cv_score=", cv_result.mean())
kfold = KFold(n_splits=4)  
cv_result = cross_val_score(model, x, y, cv=kfold)
print("Fold=4, cv_score=", cv_result.mean())
kfold = KFold(n_splits=3)  
cv_result = cross_val_score(model, x, y, cv=kfold)
print("Fold=3, cv_score=", cv_result.mean())
